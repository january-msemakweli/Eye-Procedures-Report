...
# Read the CSV file
data = []
with open('nkundi_morogoro_csv.csv', 'r', encoding='utf-8') as f:
...
markdown = f"""# Nkundi Eye Camp Report
...
plt.tight_layout()
plt.savefig('nkundi_chart_conditions_top10.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('nkundi_chart_procedures.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('nkundi_chart_gender_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('nkundi_chart_age_comparison.png', dpi=300, bbox_inches='tight')
plt.close()

markdown += """![Age Group Comparison](nkundi_chart_age_comparison.png)
"""

# Write to file
with open('nkundi_report.md', 'w', encoding='utf-8') as f:
    f.write(markdown)
